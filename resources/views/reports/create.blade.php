...
@section('title') {{ __('pages.reports.create.title') }} @endsection
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">@lang('pages.reports.create.title')</h1>
      </div>
      <!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">@lang('pages.reports.create.title')</li>
        </ol>
      </div>
      <!-- /.col -->
    </div>
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="card card-n-pink card-outline">
        <div class="card-body">
          <form action="{{ url('panel/report/create') }}" id="create-report-form" method="post">
            <div class="row">
              <!-- Input - Reported -->
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="reporter" value="{{ $user->username }}">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="sub-section">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="custom-select" name="resolving">
                    <option value="false">@lang('words.no')</option>
                    <option value="true">@lang('words.yes')</option>
                  </select>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="ticket-manager">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="server-name">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="reason" style="height: 90px; resize: none;" maxlength="200"></textarea>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="how-resolved" style="height: 90px; resize: none;" maxlength="200"></textarea>
